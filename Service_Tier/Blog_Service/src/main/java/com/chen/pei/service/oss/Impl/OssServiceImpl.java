package com.chen.pei.service.oss.Impl;
...
import com.chen.pei.utils.OssUtils;
...
public class OssServiceImpl implements OssService {
    ...
    public String uploadFileAvatar(MultipartFile file) {
        ...
        // 工具类获取值
        String endpoint = OssUtils.END_POIND;
...
//        System.out.println(endpoint + " " + accessKeyId + " " + accessKeySecret);
    ...
    public static void main(String[] args) {
        ...
        ossService.deleteImage("98a9262a107a40a594925463f9ebd1d2旅游.gif");
    }
